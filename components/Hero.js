...
const HeroSection = () => {
  return (
    <>
      <div className={` p-8 sm:p-20 dark:bg-[#182747] dark:text-white grid sm:grid-cols-12 sm:justify-center gap-8 `}>
        ...
        <div className="sm:col-span-7 flex flex-col items-start gap-4">
          ...
          <div className="py-4">
            <Link
              href="https://docs.google.com/document/d/1Six8OnGDyzbNpLEPorwWtGOHAZneFLjCxQauVwT9Clw/edit?usp=sharing"
